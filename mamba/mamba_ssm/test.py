...
model = AutoModelForCausalLM.from_pretrained("mamba/mamba_ssm/mamba_finetuned_results")
tokenizer = AutoTokenizer.from_pretrained("mamba/mamba_ssm/mamba_finetuned_results")
