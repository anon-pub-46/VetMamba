...
with open("mamba/qa-pairs/train.json") as f:
    data = json.load(f)
...
training_args = TrainingArguments(
    output_dir="mamba/mamba_ssm/mamba_finetune_new_qa_pairs_1.4b",
    num_train_epochs=3,
...
trainer.save_model("mamba/mamba_ssm/mamba_finetune_new_qa_pairs_1.4b/final_model")
tokenizer.save_pretrained("mamba/mamba_ssm/mamba_finetune_new_qa_pairs_1.4b/final_model")

# CUDA_VISIBLE_DEVICES=3,5 python mamba/mamba_ssm/models/finetune_new_qa_pairs_mamba.py
